...
const file_meal_v1_meal_proto_rawDesc = "" +
	...
	"\bposition\x18\x04 \x01(\x05R\bposition2X\n" +
	"\fMealsService\x12H\n" +
	"\vSearchMeals\x12\x1b.meal.v1.SearchMealsRequest\x1a\x1c.meal.v1.SearchMealsResponseB3Z1github.com/Vyach12/meal-api/proto/meal/v1;meal_v1b\x06proto3"
...
var file_meal_v1_meal_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_meal_v1_meal_proto_depIdxs = []int32{
	...
	0, // 4: meal.v1.MealsService.SearchMeals:input_type -> meal.v1.SearchMealsRequest
	1, // 5: meal.v1.MealsService.SearchMeals:output_type -> meal.v1.SearchMealsResponse
